...
namespace Identity.Infrastructure.Persistence.Migrations.CQRS.Commands
{
    ...
    [Migration("20211029014519_AddDataVersionPropertyAndInitializationMethodIntoEntityClass")]
    partial class AddDataVersionPropertyAndInitializationMethodIntoEntityClass
    {
            ...
            modelBuilder.Entity("Identity.Domain.Models.Customer", b =>
                {
                    ...
                    b.Property<decimal>("DataVersion")
